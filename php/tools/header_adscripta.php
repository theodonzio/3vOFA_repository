          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <li>
                ...
                <a class="dropdown-item" href="#GestionHorarios" data-traducible="Horarios">Horarios</a>
              </li>
              <li>
              ...
              <li> 
                <img src="../../img/icons/class_icon.png" class="icono">   
              <a class="dropdown-item" href="#HeroCursos" data-traducible="Cursos">Cursos</a></li>
              <li> 
               <img src="../../img/icons/abc_icon.png" class="icono">  
